...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,ReleasedDate,Genre,Price,Rating")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,ReleasedDate,Genre,Price,Rating")] Movie movie)
        {
            if (ModelState.IsValid)
            {
