...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,ReleasedDate,Genre,Price")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,ReleasedDate,Genre,Price")] Movie movie)
        {
            if (ModelState.IsValid)
            {
